...
import net.mguenther.springkafka.kafka.TransactionalMessageProducer;
...
public class MessageController {
    ...
    private final TransactionalMessageProducer producer;

    private final MessageService messageService;

    @Autowired
    public MessageController(final TransactionalMessageProducer producer, final MessageService messageService) {
